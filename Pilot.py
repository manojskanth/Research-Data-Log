...
# Child Department Folders (Mapped from your Drive links)
DEPT_FOLDERS_25_26 = {
...
# Master Spreadsheet and Central Backup Hub IDs
...
with st.form("research_submission", clear_on_submit=True):
    # Department selection (The 'Child' within the Year)
...
if submit and f_file:
    try:
        with st.spinner(f"Processing and Syncing to {f_dept}..."):
            ...
            st.success(f"✅ Record successfully synced for {f_name} ({f_dept})")
            st.balloons()
