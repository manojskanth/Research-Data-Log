...
DEPT_FOLDERS_25_26 = {
    ...
    "Social Science & Humanities": "1kwO7QrBYjnJazftv0aj8hZcp84ZKekcx", # Updated ID
...
FACULTY_GSITE_FOLDERS = {
    ...
    "Dr. Michael Preetam": "1cdtvdr94oPbe1my7yZXWw3XFjonehcfq", # Updated ID
...
with st.form("research_submission", clear_on_submit=True):
    ...
    with col1:
        # Dropdown selection for faculty
...
if submit and f_file:
    try:
        with st.spinner(f"Processing sync for {f_name}..."):
            ...
            # SYNC 1: DEPARTMENT FOLDER (Specific Drive)
            ...
            st.success(f"✅ Success! Record deposited for {f_name} in {f_dept} and Central Hub.")
            st.balloons()
